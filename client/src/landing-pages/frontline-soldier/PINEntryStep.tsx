  ...
  render() {
    return (<form onSubmit={ev => {
      ...
      <div className="pin-entry">
        <input className="input" placeholder="PIN" value={this.state.pin} onChange={ev => this.setState({ pin: ev.target.value })} />
        <button type="submit" className="btn" disabled={RDS.IsLoading(this.props.rds)}>Submit pin</button>
